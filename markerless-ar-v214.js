(function () {
  ...
  function updateArAvailability() {
    ...
    const sharedRouteReady = isAndroid && spatialSelectionReady();
  ...
  viewer.addEventListener('ar-status', (event) => {
    ...
    if (event.detail.status === 'session-started' || event.detail.status === 'object-placed') trialLog?.markDisplay();
